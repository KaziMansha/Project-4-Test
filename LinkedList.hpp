...
class LinkedList {
    ...
    public:
        ...
        //Method to copy a LinkedList but in reverse order
        void reverseCopy(const LinkedList<ItemType> &list);

        //Method to move the selected item from its current position to the front
